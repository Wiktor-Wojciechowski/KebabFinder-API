...
class KebabController extends Controller
{
     ...
     *             @OA\Property(property="pyszne_pl_link", type="string", description="Link to pyszne.pl for rating", example="https://www.pyszne.pl/menu/kebab-piri-piri-szkolna0"),
     *             @OA\Property(property="glovo_link", type="string", description="Link to glovoapp.com for rating", example="https://glovoapp.com/pl/pl/legnica/piri-piri-kebab-legnica-lga/"),
     ...
     *             @OA\Property(property="pyszne_pl_link", type="string", description="Link to pyszne.pl for rating", example="https://www.pyszne.pl/menu/kebab-piri-piri-szkolna"),
     *             @OA\Property(property="glovo_link", type="string", description="Link to glovoapp.com for rating", example="https://glovoapp.com/pl/pl/legnica/piri-piri-kebab-legnica-lga/"),
